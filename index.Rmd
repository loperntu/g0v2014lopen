...
- 在計算語言學（自然語言處理）的脈絡下，廣義的語料包括各項`語言資源`（字典 dictionary，詞庫 lexicon，語料庫 corpus，語法樹庫 treebank，知識本體 ontologies，等等。）
...
> I had the idea, but was missing the Data.... and found MOE.cc!!
